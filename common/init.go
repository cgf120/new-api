...
func printHelp() {
	fmt.Println("FZW AI " + Version + " - Unified AI gateway for model routing, billing, quota, and operational visibility.")
	fmt.Println("Usage: fzw-ai [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
